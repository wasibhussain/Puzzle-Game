...
class NormalPuzzle extends StatefulWidget {
  const NormalPuzzle({Key? key}) : super(key: key);

  @override
  _NormalPuzzleState createState() => _NormalPuzzleState();
}

class _NormalPuzzleState extends State<NormalPuzzle> {
  //
